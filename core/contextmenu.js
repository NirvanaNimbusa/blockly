 ...
 * 
 * @param {!goog.ui.Menu}
 *            menu The menu to add and position.
 * @param {!Event}
 *            e Mouse event for the right click that is making the context menu
 *            appear.
 * @param {boolean}
 *            rtl True if RTL, false if LTR.
 * @private
 ...
 * 
 * @param {!goog.ui.Menu}
 *            menu The menu to add to the widget div.
 * @private
 */
 ...
 *            block The block where the right-click originated.
 ...
 * 
 * @param {!Blockly.WorkspaceCommentSvg}
 *            comment The workspace comment where the right-click originated.
 * @return {!Object} A menu option, containing text, enabled, and a callback.
 * @package
 */
 ...
 *            ws The workspace where the right-click originated.
 * @param {!Event}
 *            e The right-click mouse event.
 * @return {!Object} A menu option, containing text, enabled, and a callback.
 * @package
 */
Blockly.ContextMenu.workspaceCommentOption = function(ws, e) {
    ...
    var addWsComment = function() {
        var comment = new Blockly.WorkspaceCommentSvg(ws, Blockly.Msg.WORKSPACE_COMMENT_DEFAULT_TEXT, Blockly.WorkspaceCommentSvg.DEFAULT_SIZE,
        ...
        var clientOffsetPixels = new Blockly.utils.Coordinate(e.clientX - boundingRect.left, e.clientY - boundingRect.top);
        ...
        // main workspace.
        var finalOffset = Blockly.utils.Coordinate.difference(clientOffsetPixels, mainOffsetPixels);
