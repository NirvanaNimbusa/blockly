 ...
 *            opt_value The initial value of the field. Should either be 'TRUE',
 *            'FALSE' or a boolean. Defaults to 'FALSE'.
 * @param {Function=}
 ...
 * 
 * @param {!Object}
 *            options A JSON object with options (checked).
 ...
 * rendered. Checkbox fields are statically sized, and only need to be rendered
 * at initialization.
 * 
 * @type {boolean}
 * @private
 ...
 * 
 * @param {string}
 *            newValue The new value ('TRUE' or 'FALSE') of the field.
 * @protected
 */
 ...
 * 
 * @return {string} Text representing the value of this field ('true' or
 *         'false').
 */
 ...
 * 
 * Converts 'TRUE' to true and 'FALSE' to false correctly, everything else is
 * cast to a boolean.
 * 
 * @param {*}
