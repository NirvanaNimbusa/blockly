...
Blockly.Mutator.prototype.drawIcon_ = function(group) {
    ...
    Blockly.utils.dom.createSvgElement('path', {
        ...
        'd' : 'm4.203,7.296 0,1.368 -0.92,0.677 -0.11,0.41 0.9,1.559 0.41,' + '0.11 1.043,-0.457 1.187,0.683 0.127,1.134 0.3,0.3 1.8,0 0.3,'
                + '-0.299 0.127,-1.138 1.185,-0.682 1.046,0.458 0.409,-0.11 0.9,' + '-1.559 -0.11,-0.41 -0.92,-0.677 0,-1.366 0.92,-0.677 0.11,'
                + '-0.41 -0.9,-1.559 -0.409,-0.109 -1.046,0.458 -1.185,-0.682 ' + '-0.127,-1.138 -0.3,-0.299 -1.8,0 -0.3,0.3 -0.126,1.135 -1.187,'
...
Blockly.Mutator.prototype.createEditor_ = function() {
    /*
     * Create the editor. Here's the markup that will be generated: <svg>
     * [Workspace] </svg>
     */
...
Blockly.Mutator.prototype.updateEditable = function() {
    if (!this.block_.isInFlyout) {
        if (this.block_.isEditable()) {
            if (this.iconGroup_) {
                Blockly.utils.dom.removeClass((this.iconGroup_), 'blocklyIconGroupReadonly');
            }
        } else {
...
/**
 * Update the source block when the mutator's blocks are changed. Bump down any
 * block that's too high. Fired whenever a change is made to the mutator's
 * workspace.
 * 
 * @param {!Blockly.Events.Abstract}
 *            e Custom data for event.
 * @private
 */
Blockly.Mutator.prototype.workspaceChanged_ = function(e) {
    if (e.type == Blockly.Events.UI || (e.type == Blockly.Events.CHANGE && e.element == 'disabled')) {
        return;
    }
 ...
 *            connectionChild Connection on child block.
 * @param {!Blockly.Block}
 *            block Parent block.
 * @param {string}
 ...
 *            workspace The workspace that is inside a mutator.
