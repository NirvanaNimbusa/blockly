 ...
 * 
 * @param {string=}
 *            src The URL of the image. Defaults to an empty string.
 * @param {!(string|number)}
 ...
 * @param {Function=}
 *            opt_onClick Optional function to be called when the image is
 *            clicked. If opt_onClick is defined, opt_alt must also be defined.
 * @param {boolean=}
 *            opt_flipRtl Whether to flip the icon in RTL.
...
/**
 * Construct a FieldImage from a JSON arg object, dereferencing any string table
 * references.
 * 
 * @param {!Object}
 *            options A JSON object with options (src, width, height, alt, and
 *            flipRtl).
 ...
 * rendered. Image fields are statically sized, and only need to be rendered at
 * initialization.
 * 
 * @type {boolean}
 * @private
