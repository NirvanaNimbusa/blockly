...
/**
 * @fileoverview Utility methods for string manipulation. These methods are not
 ...
 * @param {string}
 *            prefix A string to look for at the start of `str`.
...
Blockly.utils.string.wrapMutate_ = function(words, wordBreaks, limit) {
    ...
    for (var i = 0; i < wordBreaks.length - 1; i++) {
        ...
        var mutatedScore = Blockly.utils.string.wrapScore_(words, mutatedWordBreaks, limit);
