...
/**
 * @fileoverview Useragent detection. These methods are not specific to Blockly,
 *               and could be factored out into a JavaScript framework such as
 *               Closure.
...
(function(raw) {
    ...
    Blockly.utils.userAgent.GECKO = has('Gecko') && !Blockly.utils.userAgent.WEBKIT && !Blockly.utils.userAgent.IE && !Blockly.utils.userAgent.EDGE;
    ...
    Blockly.utils.userAgent.IPHONE = has('iPhone') && !Blockly.utils.userAgent.IPAD && !Blockly.utils.userAgent.IPOD;
    ...
    Blockly.utils.userAgent.TABLET = Blockly.utils.userAgent.IPAD || (Blockly.utils.userAgent.ANDROID && !has('Mobile')) || has('Silk');
    Blockly.utils.userAgent.MOBILE = !Blockly.utils.userAgent.TABLET
            && (Blockly.utils.userAgent.IPOD || Blockly.utils.userAgent.IPHONE || Blockly.utils.userAgent.ANDROID || has('IEMobile'));
