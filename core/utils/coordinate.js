...
/**
 * @fileoverview Utility methods for coordinate manipulation. These methods are
 *               not specific to Blockly, and could be factored out into a
 ...
 * 
 * @param {!Blockly.utils.Coordinate|!SVGPoint}
 *            a An x/y coordinate.
 * @param {!Blockly.utils.Coordinate|!SVGPoint}
 *            b An x/y coordinate.
 ...
 * @param {!Blockly.utils.Coordinate|!SVGPoint}
 *            b An x/y coordinate.
 * @return {!Blockly.utils.Coordinate} A Coordinate representing the sum of the
 *         two coordinates.
 */
 ...
 * 
 * @param {number}
 *            s The scale factor to use for both x and y dimensions.
 ...
 * 
 * @param {number}
 *            tx The value to translate x by.
 * @param {number}
 *            ty The value to translate y by.
