...
/**
 * @fileoverview Utility methods for DOM manipulation. These methods are not
 ...
 * 
 * @param {!Node}
 *            parent The node that should contain the other node.
 * @param {!Node}
 *            descendant The node to test presence of.
 * @return {boolean} Whether the parent node contains the descendant node.
 */
Blockly.utils.dom.containsNode = function(parent, descendant) {
    return !!(parent.compareDocumentPosition(descendant) & Blockly.utils.dom.Node.DOCUMENT_POSITION_CONTAINED_BY);
};
 ...
 * 
 * @param {!Element}
 *            element Element to which the CSS transform will be applied.
 * @param {string}
 *            transform The value of the CSS `transform` property.
 */
