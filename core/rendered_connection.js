 ...
 *            otherConnection The other connection to measure the distance to.
...
Blockly.RenderedConnection.prototype.bumpAwayFrom_ = function(staticConnection) {
    ...
    var dx = (staticConnection.x_ + Blockly.SNAP_RADIUS + Math.floor(Math.random() * Blockly.BUMP_RANDOMNESS)) - this.x_;
    var dy = (staticConnection.y_ + Blockly.SNAP_RADIUS + Math.floor(Math.random() * Blockly.BUMP_RANDOMNESS)) - this.y_;
    if (reverse) {
        // When reversing a bump due to an uneditable block, bump up.
        dy = -dy;
    }
    if (rootBlock.RTL) {
        dx = (staticConnection.x_ - Blockly.SNAP_RADIUS - Math.floor(Math.random() * Blockly.BUMP_RANDOMNESS)) - this.x_;
    }
 ...
 * 
 * @param {number}
 *            x New absolute x coordinate, in workspace coordinates.
 * @param {number}
 *            y New absolute y coordinate, in workspace coordinates.
 */
 ...
 * 
 * @param {number}
 *            dx Change to x coordinate, in workspace units.
 * @param {number}
 *            dy Change to y coordinate, in workspace units.
 */
 ...
 *            blockTL The location of the top left corner of the block, in
 ...
 * 
 * @param {number}
 *            x The new relative x, in workspace units.
 * @param {number}
 *            y The new relative y, in workspace units.
 */
...
/**
 * Find the closest compatible connection to this connection. All parameters are
 * in workspace units.
 * 
 * @param {number}
 *            maxLimit The maximum radius to another connection.
 * @param {!Blockly.utils.Coordinate}
 *            dxy Offset between this connection's location in the database and
 ...
 * 
 * @param {boolean}
 *            hidden True if connection is hidden.
 */
 ...
 * @param {number}
 *            maxRadius The maximum radius allowed for connections, in workspace
 *            units.
 ...
 * 
 * @param {number}
 *            maxLimit The maximum radius to another connection, in workspace
 *            units.
