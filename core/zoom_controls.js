 ...
 * 
 * @param {number}
 *            verticalSpacing Vertical distances from workspace edge to the same
...
/**
 * Dispose of this zoom controls. Unlink from all DOM elements to prevent memory
 * leaks.
 */
...
/**
 * Position the zoom controls. It is positioned in the opposite corner to the
 * corner the categories/toolbox starts at.
 */
Blockly.ZoomControls.prototype.position = function() {
    ...
    if (metrics.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM) {
        ...
        this.top_ = metrics.viewHeight + metrics.absoluteTop - this.HEIGHT_ - this.verticalSpacing_;
 ...
 * 
 * @param {string}
 *            rnd The random string to use as a suffix in the clip path's ID.
 *            These IDs must be unique in case there are multiple Blockly
 *            instances on the same page.
 * @private
 */
Blockly.ZoomControls.prototype.createZoomOutSvg_ = function(rnd) {
    /*
     * This markup will be generated and added to the .svgGroup_: <g
     * class="blocklyZoom"> <clipPath id="blocklyZoomoutClipPath837493"> <rect
     * width="32" height="32></rect> </clipPath> <image width="96" height="124"
     * x="-64" y="-92" xlink:href="media/sprites.png"
     * clip-path="url(#blocklyZoomoutClipPath837493)"></image> </g>
     */
    ...
    zoomoutSvg.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href', ws.options.pathToMedia + Blockly.SPRITE.url);
...
Blockly.ZoomControls.prototype.createZoomInSvg_ = function(rnd) {
    /*
     * This markup will be generated and added to the .svgGroup_: <g
     * class="blocklyZoom"> <clipPath id="blocklyZoominClipPath837493"> <rect
     * width="32" height="32"></rect> </clipPath> <image width="96"
     * height="124" x="-32" y="-92" xlink:href="media/sprites.png"
     * clip-path="url(#blocklyZoominClipPath837493)"></image> </g>
     */
    var ws = this.workspace_;
    ...
    zoominSvg.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href', ws.options.pathToMedia + Blockly.SPRITE.url);
...
Blockly.ZoomControls.prototype.createZoomResetSvg_ = function(rnd) {
    /*
     * This markup will be generated and added to the .svgGroup_: <g
     * class="blocklyZoom"> <clipPath id="blocklyZoomresetClipPath837493"> <rect
     * width="32" height="32"></rect> </clipPath> <image width="96"
     * height="124" x="-32" y="-92" xlink:href="media/sprites.png"
     * clip-path="url(#blocklyZoomresetClipPath837493)"></image> </g>
     */
    var ws = this.workspace_;
    ...
    zoomresetSvg.setAttributeNS(Blockly.utils.dom.XLINK_NS, 'xlink:href', ws.options.pathToMedia + Blockly.SPRITE.url);
