...
/**
 * Class for a UI event. UI events are events that don't need to be sent over
 * the wire for multi-user editing to work (e.g. scrolling the workspace,
 * zooming, opening toolbox categories). UI events do not undo or redo.
 * 
 * @param {Blockly.Block}
 *            block The affected block.
 * @param {string}
 *            element One of 'selected', 'comment', 'mutatorOpen', etc.
 * @param {*}
