 ...
 * Get stored location.
 * 
 * @return {!Blockly.utils.Coordinate} The comment's stored location. This is
 *         not valid if the comment is currently being dragged.
 * @package
 */
...
/**
 * Encode a comment subtree as XML, but don't serialize the XY coordinates. This
 * method avoids some expensive metrics-related calls that are made in
 * toXmlWithXY().
 * 
 * @param {boolean=}
 *            opt_noId True if the encoder should skip the comment ID.
