...
Blockly.DraggedConnectionManager = function(block) {
     ...
     * block were released immediately. Updated on every mouse move.
     * 
     * @type {Blockly.RenderedConnection}
     * @private
     */
     ...
     * in workspace units. Updated on every mouse move.
     * 
     * @type {number}
     * @private
     */
 ...
 * 
 * @param {!Blockly.utils.Coordinate}
 *            dxy Position relative to the drag start, in workspace units.
