 ...
 * workspace when they are being dragged by a mouse or touch. These can be block
 * comments, mutators, warnings, or workspace comments.
 * 
 * @param {!Blockly.Bubble|!Blockly.WorkspaceCommentSvg}
 *            bubble The item on the bubble canvas to drag.
...
/**
 * Shut the trash can and, if necessary, delete the dragging bubble. Should be
 * called at the end of a bubble drag.
 * 
