 ...
 * @param {boolean}
 *            rtl Right-to-left (true) or left-to-right (false).
 * @param {Function}
 ...
 * 
 * @param {number}
 *            x Horizontal location (window coordinates, not body).
 * @param {number}
 *            y Vertical location (window coordinates, not body).
 * @param {number}
 *            height The height of the widget div (pixels).
 * @private
 */
...
/**
 * Position the widget div based on an anchor rectangle. The widget should be
 * placed adjacent to but not overlapping the anchor rectangle. The preferred
 * position is directly below and aligned to the left (LTR) or right (RTL) side
 * of the anchor.
 * 
 * @param {!Object}
 *            viewportBBox The bounding rectangle of the current viewport, in
 *            window coordinates.
 * @param {!Object}
 *            anchorBBox The bounding rectangle of the anchor, in window
 *            coordinates.
 * @param {!goog.math.Size}
 *            widgetSize The size of the widget that is inside the widget div,
 *            in window coordinates.
 * @param {boolean}
 *            rtl Whether the workspace is in RTL mode. This determines
 ...
 *            coordinates.
 * @param {goog.math.Size}
 *            widgetSize The dimensions of the widget inside the widget div.
 * @param {boolean}
 *            rtl Whether the Blockly workspace is in RTL mode.
