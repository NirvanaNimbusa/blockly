 ...
 * 
 * @param {string=}
 *            opt_value The initial value of the field. Should be in '#rrggbb'
 *            format. Defaults to the first value in the default colour array.
 * @param {Function=}
 *            opt_validator A function that is called to validate changes to the
 *            field's value. Takes in a colour string & returns a validated
 *            colour string ('#rrggbb' format), or null to abort the change.
...
Blockly.FieldColour = function(opt_value, opt_validator) {
    ...
    Blockly.FieldColour.superClass_.constructor.call(this, opt_value, opt_validator);
};
 ...
 * 
 * @param {!Object}
 *            options A JSON object with options (colour).
 ...
 * rendered. Colour fields are statically sized, and only need to be rendered at
 * initialization.
 * 
 * @type {boolean}
 * @private
...
/**
 * Number of colour columns used by this field. If 0, use the global setting. By
 * default use the global constants for columns.
 * 
 * @type {number}
 * @private
 */
 ...
 * 
 * @param {string}
 *            newValue The new colour in '#rrggbb' format.
 * @protected
 */
...
/**
 * An array of colour strings for the palette. Copied from
 * goog.ui.ColorPicker.SIMPLE_GRID_COLORS All colour pickers use this unless
 * overridden with setColours.
 * 
 * @type {!Array.<string>}
 */
 ...
 * COLOURS, the colour's hex code will be used for any missing titles. All
 * colour pickers use this unless overridden with setColours.
 * 
 * @type {!Array.<string>}
 */
...
/**
 * Number of columns in the palette. All colour pickers use this unless
 * overridden with setColumns.
 */
 ...
 * 
 * @param {Array.
 *            <string>} colours Array of colours for this block, or null to use
 *            default (Blockly.FieldColour.COLOURS).
 * @param {Array.
 *            <string>} opt_titles Optional array of colour tooltips, or null to
 *            use default (Blockly.FieldColour.TITLES).
 ...
 * 
 * @param {number}
 *            columns Number of columns for this block, or 0 to use default
