 ...
 * 
 * @param {!Node}
 *            treeIn DOM tree of blocks.
 * @param {!Blockly.Toolbox.TreeControl}
 *            treeOut The TreeContorol object built from treeIn.
 * @param {string}
 *            pathToMedia The path to the Blockly media directory.
 * @return {Node} Tree node to open at startup (or null).
 * @private
 */
Blockly.Toolbox.prototype.syncTrees_ = function(treeIn, treeOut, pathToMedia) {
    ...
    for (var i = 0, childIn; childIn = treeIn.childNodes[i]; i++) {
        ...
        case 'CATEGORY':
            ...
            if (colour && styleName) {
                childOut.hexColour = '';
                console.warn('Toolbox category "' + categoryName + '" can not have both a style and a colour');
            } else if (styleName) {
 ...
 * 
 * @param {number|string}
 *            colourValue HSV hue value (0 to 360), #RRGGBB string, or a message
 *            reference string pointing to one of those two values.
 * @param {Blockly.Toolbox.TreeNode}
 *            childOut The child to set the hexColour on.
 * @param {string}
 *            categoryName Name of the toolbox category.
 * @private
 */
...
/**
 * Retrieves and sets the colour for the category using the style name. The
 * category colour is set from the colour style attribute.
 * 
 * @param {string}
 ...
 *            categoryName Name of the toolbox category.
 */
Blockly.Toolbox.prototype.setColourFromStyle_ = function(styleName, childOut, categoryName) {
 ...
 * 
 * @param {Blockly.Toolbox.TreeNode=}
 *            opt_tree Starting point of tree. Defaults to the root node.
 * @private
 */
 ...
 * 
 * @param {!Blockly.Toolbox.TreeNode}
 *            tree Starting point of tree. Defaults to the root node.
 * @private
 */
 ...
 * 
 * @param {string}
 *            style The name of the class to add.
 * @package
 */
 ...
 * 
 * @param {string}
 *            style The name of the class to remove.
 * @package
 */
 ...
 * 
 * @param {Blockly.Toolbox}
 *            toolbox The parent toolbox for this tree.
 * @param {Object}
 *            config The configuration for the tree. See
 ...
 * 
 * @param {string=}
 *            opt_html The HTML content of the node label.
...
/**
 * Remap event.keyCode in horizontalLayout so that arrow keys work properly and
