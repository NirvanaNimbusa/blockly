 ...
 * 
 * @param {Blockly.Block}
 *            block The block this event corresponds to.
 ...
 * 
 * @param {Blockly.Block}
 *            block The changed block. Null for a blank event.
 * @param {string}
 *            element One of 'field', 'comment', 'disabled', etc.
 * @param {?string}
 *            name Name of input or field affected, or null.
 * @param {*}
 *            oldValue Previous value of element.
 * @param {*}
 ...
 * 
 * @param {Blockly.Block}
 *            block The created block. Null for a blank event.
 * @extends {Blockly.Events.BlockBase}
 * @constructor
 */
 ...
 * 
 * @param {Blockly.Block}
 *            block The deleted block. Null for a blank event.
 * @extends {Blockly.Events.BlockBase}
 * @constructor
 */
 ...
 * 
 * @param {Blockly.Block}
 *            block The moved block. Null for a blank event.
 * @extends {Blockly.Events.BlockBase}
 * @constructor
 */
...
Blockly.Events.Move.prototype.fromJson = function(json) {
    ...
    if (json['newCoordinate']) {
        ...
        this.newCoordinate = new Blockly.utils.Coordinate(parseFloat(xy[0]), parseFloat(xy[1]));
    }
};
...
/**
 * Returns the parentId and input if the block is connected, or the XY location
 * if disconnected.
 * 
...
Blockly.Events.Move.prototype.isNull = function() {
    return this.oldParentId == this.newParentId && this.oldInputName == this.newInputName
