 ...
 * 
 * @param {!Object.
 *            <string, Blockly.Theme.Style>} blockStyles A map from style names
 *            (strings) to objects with style attributes relating to blocks.
 * @param {!Object.
 *            <string, Blockly.Theme.Style>} categoryStyles A map from style
 *            names (strings) to objects with style attributes relating to
 *            categories.
 * @constructor
 */
 ...
 * 
 * @param {Object.
 *            <string, Blockly.Theme.Style>} blockStyles Map of block styles.
 */
 ...
 * 
 * @param {string}
 *            blockStyleName The name of the block style.
 ...
 * @param {string}
 *            blockStyleName The name of the block style.
 * @param {Blockly.Theme.Style}
 *            blockStyle The block style.
 */
 ...
 * 
 * @param {string}
 *            categoryStyleName The name of the category style.
 ...
 *            categoryStyleName The name of the category style.
 * @param {Blockly.Theme.Style}
 *            categoryStyle The category style.
 */
