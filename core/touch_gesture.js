...
/**
 * @fileoverview The class extends Blockly.Gesture to support pinch to zoom for
...
Blockly.TouchGesture = function(e, creatorWorkspace) {
     ...
     * and the most recent distance between the touch points. Scales between 0
     * and 1 mean the most recent zoom was a zoom out. Scales above 1.0 mean the
     * most recent zoom was a zoom in.
     * 
     * @type {number}
     * @private
     */
     ...
     * at the end of a drag. Opaque data returned from
 ...
 * 
 * @param {!Event}
 *            e A mouse down, touch start or pointer down event.
 * @package
 */
...
/**
 * Bind gesture events. Overriding the gesture definition of this function,
 * binding the same functions for onMoveWrapper_ and onUpWrapper_ but passing
 * opt_noCaptureIdentifier. In addition, binding a second mouse down event to
...
Blockly.TouchGesture.prototype.bindMouseEvents = function(e) {
    this.onStartWrapper_ = Blockly.bindEventWithChecks_(document, 'mousedown', null, this.handleStart.bind(this),
 ...
 * 
 * @param {!Event}
 *            e A mouse move, touch move, or pointer move event.
 * @package
 */
 ...
 * 
 * @param {!Event}
 *            e A mouse up, touch end, or pointer up event.
 * @package
 */
 ...
 * 
 * @param {!Event}
 *            e A touch start, or pointer down event.
 * @package
 */
...
/**
 * Handle a touch move or pointer move event and zoom in/out if two pointers are
 * on the screen.
 * 
 * @param {!Event}
 *            e A touch move, or pointer move event.
 * @package
 */
 ...
 * 
 * @param {!Event}
 *            e A touch end, or pointer end event.
 * @package
 */
...
Blockly.TouchGesture.prototype.getTouchPoint = function(e) {
    ...
    return new Blockly.utils.Coordinate((e.pageX ? e.pageX : e.changedTouches[0].pageX), (e.pageY ? e.pageY : e.changedTouches[0].pageY));
};
