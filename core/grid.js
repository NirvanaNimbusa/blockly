 ...
 * 
 * @param {!SVGElement}
 *            pattern The grid's SVG pattern, created during injection.
 * @param {!Object}
 *            options A dictionary of normalized options for the grid. See grid
 *            documentation:
...
/**
 * The scale of the grid, used to set stroke width on grid lines. This should
 * always be the same as the workspace scale.
 * 
 * @type {number}
 * @private
 */
 ...
 * @param {number}
 *            width The new stroke size (in px).
 * @param {number}
 *            x1 The new x start position of the line (in px).
 * @param {number}
 *            x2 The new x end position of the line (in px).
 * @param {number}
 *            y1 The new y start position of the line (in px).
 * @param {number}
 *            y2 The new y end position of the line (in px).
 * @private
 */
 ...
 * 
 * @param {number}
 *            x The new x position of the grid (in px).
 * @param {number}
 *            y The new y position ofthe grid (in px).
 * @package
 */
 ...
 * 
 * @param {string}
 *            rnd A random ID to append to the pattern's ID.
 * @param {!Object}
 *            gridOptions The object containing grid configuration.
 * @param {!SVGElement}
 *            defs The root SVG element for this workspace's defs.
...
Blockly.Grid.createDom = function(rnd, gridOptions, defs) {
     ...
     * <rect stroke="#888" /> <rect stroke="#888" /> </pattern>
     */
