...
/**
 * @fileoverview Non-editable, serializable text field. Behaves like a normal
 *               label but is serialized to XML. It may only be edited
 *               programmatically.
 */
'use strict';
...
Blockly.FieldLabelSerializable = function(opt_value, opt_class) {
    Blockly.FieldLabelSerializable.superClass_.constructor.call(this, opt_value, opt_class);
};
goog.inherits(Blockly.FieldLabelSerializable, Blockly.FieldLabel);

/**
 * Construct a FieldLabelSerializable from a JSON arg object, dereferencing any
 * string table references.
 * 
 * @param {!Object}
 *            options A JSON object with options (text, and class).
