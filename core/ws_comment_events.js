 ...
 *            comment The comment this event corresponds to.
 ...
 * 
 * @param {Blockly.WorkspaceComment}
 *            comment The comment that is being changed. Null for a blank event.
 * @param {string}
 *            oldContents Previous contents of the comment.
 * @param {string}
 *            newContents New contents of the comment.
 ...
 * 
 * @param {boolean}
 *            forward True if run forward, false if run backward (undo).
 */
 ...
 * 
 * @param {Blockly.WorkspaceComment}
 *            comment The created comment. Null for a blank event.
 * @extends {Blockly.Events.CommentBase}
 * @constructor
 */
 ...
 * 
 * @param {!Blockly.Events.CommentCreate|!Blockly.Events.CommentDelete}
 *            event The event to run.
 * @param {boolean}
 *            create if True then Create, if False then Delete
 */
 ...
 * 
 * @param {Blockly.WorkspaceComment}
 *            comment The deleted comment. Null for a blank event.
 * @extends {Blockly.Events.CommentBase}
 * @constructor
 */
 ...
 * 
 * @param {Blockly.WorkspaceComment}
 *            comment The comment that is being moved. Null for a blank event.
 * @extends {Blockly.Events.CommentBase}
 * @constructor
 */
...
/**
 * Record the comment's new location. Called after the move. Can only be called
 * once.
 */
...
/**
 * Override the location before the move. Use this if you don't create the event
 * until the end of the move, but you know the original location.
 * 
 * @param {!Blockly.utils.Coordinate}
 *            xy The location before the move, in workspace coordinates.
 */
...
Blockly.Events.CommentMove.prototype.fromJson = function(json) {
    ...
    if (json['newCoordinate']) {
        ...
        this.newCoordinate_ = new Blockly.utils.Coordinate(parseFloat(xy[0]), parseFloat(xy[1]));
    }
};
