...
Blockly.Tooltip.show_ = function() {
    ...
    if (anchorY + Blockly.Tooltip.DIV.offsetHeight > windowHeight + window.scrollY) {
    ...
    if (rtl) {
        ...
        if (anchorX + Blockly.Tooltip.DIV.offsetWidth > windowWidth + window.scrollX - 2 * Blockly.Tooltip.MARGINS) {
            // Falling off the right edge of the screen;
            // clamp the tooltip on the edge.
            anchorX = windowWidth - Blockly.Tooltip.DIV.offsetWidth - 2 * Blockly.Tooltip.MARGINS;
        }
    }
