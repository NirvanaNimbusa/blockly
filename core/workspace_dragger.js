...
/**
 * Class for a workspace dragger. It moves the workspace around when it is being
 * dragged by a mouse or touch. Note that the workspace itself manages whether
 * or not it has a drag surface and how to do translations based on that. This
 * simply passes the right commands based on events.
 * 
 * @param {!Blockly.WorkspaceSvg}
 *            workspace The workspace to drag.
 * @constructor
 */
Blockly.WorkspaceDragger = function(workspace) {
     ...
     * @private
     */
    this.startScrollXY_ = new Blockly.utils.Coordinate(workspace.scrollX, workspace.scrollY);
};
