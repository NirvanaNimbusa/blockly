...
Blockly.WorkspaceCommentSvg.prototype.createEditor_ = function() {
     ...
     * style="height: 164px; width: 164px;"></textarea> </body>
     * </foreignObject>
     */
...
Blockly.WorkspaceCommentSvg.prototype.resizeMouseDown_ = function(e) {
    ...
    this.workspace.startDrag(e, new Blockly.utils.Coordinate(this.workspace.RTL ? -this.width_ : this.width_, this.height_));
...
Blockly.WorkspaceCommentSvg.prototype.setSize_ = function(width, height) {
    ...
    if (this.resizeGroup_) {
        if (this.RTL) {
            ...
            this.deleteGroup_.setAttribute('transform', 'translate(' + (width - resizeSize) + ',' + (-resizeSize) + ')');
        }
    }
...
Blockly.WorkspaceCommentSvg.prototype.setFocus = function() {
    ...
    setTimeout(function() {
        ...
        comment.addFocus();
        Blockly.utils.dom.addClass(comment.svgRectTarget_, 'blocklyCommentTargetFocused');
        Blockly.utils.dom.addClass(comment.svgHandleTarget_, 'blocklyCommentHandleTargetFocused');
    }, 0);
};
...
Blockly.WorkspaceCommentSvg.prototype.blurFocus = function() {
    ...
    setTimeout(function() {
        ...
        comment.removeFocus();
        Blockly.utils.dom.removeClass(comment.svgRectTarget_, 'blocklyCommentTargetFocused');
        Blockly.utils.dom.removeClass(comment.svgHandleTarget_, 'blocklyCommentHandleTargetFocused');
    }, 0);
};
