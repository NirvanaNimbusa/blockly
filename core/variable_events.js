 ...
 *            variable The variable this event corresponds to.
 ...
 * 
 * @param {Blockly.VariableModel}
 *            variable The created variable. Null for a blank event.
 ...
 * 
 * @param {Blockly.VariableModel}
 *            variable The deleted variable. Null for a blank event.
 * @extends {Blockly.Events.VarBase}
 * @constructor
 */
 ...
 * 
 * @param {Blockly.VariableModel}
 *            variable The renamed variable. Null for a blank event.
 * @param {string}
 *            newName The new name the variable will be changed to.
 * @extends {Blockly.Events.VarBase}
 * @constructor
 */
