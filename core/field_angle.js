 ...
 * 
 * @param {!Object}
 *            options A JSON object with options (angle).
 ...
 * picker. While many combinations are possible, two modes are typical: Math
 * mode. 0 deg is right, 90 is up. This is the style used by protractors.
 * Blockly.FieldAngle.CLOCKWISE = false; Blockly.FieldAngle.OFFSET = 0; Compass
 * mode. 0 deg is up, 90 is right. This is the style used by maps.
 * Blockly.FieldAngle.CLOCKWISE = true; Blockly.FieldAngle.OFFSET = 90;
 */
...
/**
 * Offset the location of 0 degrees (and all angles) by a constant. Usually
 * either 0 (0 = right) or 90 (0 = up).
 */
Blockly.FieldAngle.OFFSET = 0;

/**
 * Maximum allowed angle before wrapping. Usually either 360 (for 0 to 359.9) or
 * 180 (for -179.9 to 180).
 */
...
Blockly.FieldAngle.prototype.dropdownCreate_ = function() {
    ...
    this.clickWrapper_ = Blockly.bindEvent_(svg, 'click', this, this.hide_);
