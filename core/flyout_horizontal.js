...
Blockly.HorizontalFlyout.prototype.position = function() {
    ...
    if (this.targetWorkspace_.toolboxPosition == this.toolboxPosition_) {
        ...
        if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP) {
            ...
            // of the flyout.
            var y = targetWorkspaceMetrics.viewHeight + targetWorkspaceMetrics.absoluteTop - this.height_;
        }
    }
...
Blockly.HorizontalFlyout.prototype.isDragTowardWorkspace = function(currentDragDeltaXY) {
    ...
    if ((dragDirection < 90 + range && dragDirection > 90 - range) || (dragDirection > -90 - range && dragDirection < -90 + range)) {
        return true;
    }
    return false;
};
...
/**
 * Compute height of flyout. Position mat under each block. For RTL: Lay out the
 * blocks right-aligned.
 * 
 * @private
 */
