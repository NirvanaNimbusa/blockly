...
/**
 * Gets a localized message. Overrides the default Closure function to check for
 * a Blockly.Msg first. Used infrequently, only known case is TODAY button in
 * date picker.
 * 
 * @param {string}
 *            str Translatable string, places holders in the form {$foo}.
 * @param {Object.
 *            <string, string>=} opt_values Maps place holder name to value.
