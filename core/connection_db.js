...
/**
 * Find the given connection. Starts by doing a binary search to find the
 * approximate location, then linearly searches nearby for the exact connection.
 * 
 * @param {!Blockly.Connection}
 *            conn The connection to find.
 * @return {number} The index of the connection, or -1 if the connection was not
 *         found.
 */
...
/**
 * Finds a candidate position for inserting this connection into the list. This
 * will be in the correct y order but makes no guarantees about ordering in the
 * x axis.
 * 
 * @param {!Blockly.Connection}
...
/**
 * Find all nearby connections to the given connection. Type checking does not
 * apply, since this function is used for bumping.
 * 
 * @param {!Blockly.Connection}
 *            connection The connection whose neighbours should be returned.
 * @param {number}
 *            maxRadius The maximum radius to another connection.
...
/**
 * Is the candidate connection close to the reference connection. Extremely
 * fast; only looks at Y distance.
 * 
 * @param {number}
 *            index Index in database of candidate connection.
 * @param {number}
 *            baseY Reference connection's Y value.
 * @param {number}
 *            maxRadius The maximum radius to another connection.
 ...
 * 
 * @param {!Blockly.Connection}
 *            conn The connection searching for a compatible mate.
 * @param {number}
 *            maxRadius The maximum radius to another connection.
