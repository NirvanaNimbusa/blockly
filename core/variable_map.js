...
/**
 * Update the name of the given variable and refresh all references to it. The
 * new name must not conflict with any existing variable names.
 * 
 * @param {!Blockly.VariableModel}
 *            variable Variable to rename.
 * @param {string}
 *            newName New variable name.
 * @param {!Array.
 *            <!Blockly.Block>} blocks The list of all blocks in the workspace.
 * @private
 */
 ...
 * of the existing variable that was already using newName. Refresh all
 ...
 *            newName New variable name.
 * @param {!Blockly.VariableModel}
 *            conflictVar The variable that was already using newName.
 * @param {!Array.
 *            <!Blockly.Block>} blocks The list of all blocks in the workspace.
 * @private
 */
...
Blockly.VariableMap.prototype.createVariable = function(name, opt_type, opt_id) {
    ...
    if (variable) {
        if (opt_id && variable.getId() != opt_id) {
            throw Error('Variable "' + name + '" is already in use and its id is "' + variable.getId() + '" which conflicts with the passed in ' + 'id, "'
                    + opt_id + '".');
        }
...
/**
 * Find the variable by the given name and type and return it. Return null if it
 * is not found.
 * 
 * @param {string}
 ...
 * 
 * @param {?Blockly.Workspace}
 *            ws The workspace used to look for potential variables. This can be
 *            different than the workspace stored on this object if the passed
 *            in ws is a flyout workspace.
