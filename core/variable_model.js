...
/**
 * Class for a variable model. Holds information for the variable including
 * name, ID, and type.
 * 
 * @param {!Blockly.Workspace}
 *            workspace The variable's workspace.
 * @param {string}
...
Blockly.VariableModel = function(workspace, name, opt_type, opt_id) {
    ...
    /**
     * A unique id for the variable. This should be defined at creation and not
     * change, even if the name changes. In most cases this should be a UUID.
     * 
     * @type {string}
     * @private
     */
