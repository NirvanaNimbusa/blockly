 ...
 *            workspace The workspace in which to place this button.
 * @param {!Blockly.WorkspaceSvg}
 *            targetWorkspace The flyout's target workspace.
 * @param {!Element}
 *            xml The XML specifying the label/button.
 * @param {boolean}
 *            isLabel Whether this button should be styled as a label.
 * @constructor
 */
...
Blockly.FlyoutButton.prototype.onMouseUp_ = function(e) {
    ...
    } else if (!this.isLabel_ && !(this.callbackKey_ && this.targetWorkspace_.getButtonCallback(this.callbackKey_))) {
