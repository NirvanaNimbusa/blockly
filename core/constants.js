...
/**
 * Maximum misalignment between connections for them to snap together, when a
...
/**
 * ENUM representing that an event is not in any delete areas. Null for
...
/**
 * String for use in the "custom" attribute of a category in toolbox XML. This
 * string indicates that the category should be dynamically populated with
 * variable blocks.
 * 
 * @const {string}
 */
...
/**
 * String for use in the dropdown created in field_variable. This string
 * indicates that this option in the dropdown is 'Rename variable...' and if
 * selected, should trigger the prompt to rename a variable.
 * 
 * @const {string}
 */
...
/**
 * String for use in the dropdown created in field_variable. This string
 * indicates that this option in the dropdown is 'Delete the "%1" variable' and
 * if selected, should trigger the prompt to delete a variable.
 * 
 * @const {string}
 */
