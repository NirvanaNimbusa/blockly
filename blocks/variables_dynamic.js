 ...
 * setter/getter. Used by blocks 'variables_set_dynamic' and
...
Blockly.Constants.VariablesDynamic.CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = {
    ...
    /**
     * Called whenever anything on the workspace changes. Set the connection
     * type for this block.
     * 
...
/**
 * Callback for rename variable dropdown menu option associated with a variable
 * getter block.
 * 
 * @param {!Blockly.Block}
 *            block The block with the variable to rename.
...
/**
 * Callback for delete variable dropdown menu option associated with a variable
 * getter block.
 * 
 * @param {!Blockly.Block}
 *            block The block with the variable to delete.
