...
/**
 * Mixin to add a context menu item to create a 'variables_get' block. Used by
 * blocks 'controls_for' and 'controls_forEach'.
 * 
 * @mixin
...
/**
 * This mixin adds a check to make sure the 'controls_flow_statements' block is
 * contained in a loop. Otherwise a warning is added to the block.
 * 
 * @mixin
 * @augments Blockly.Block
 * @package
...
Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN = {
    /**
     * List of block types that are loops and thus do not need warnings. To add
     * a new loop type add this to your code:
    ...
    /**
     * Don't automatically add STATEMENT_PREFIX and STATEMENT_SUFFIX to
     * generated code. These will be handled manually in this block's
     * generators.
     */
    ...
    onchange : function(_e) {
        ...
        if (Blockly.Constants.Loops.CONTROL_FLOW_IN_LOOP_CHECK_MIXIN.getSurroundLoop(this)) {
