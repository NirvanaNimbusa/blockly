        ...
        },
        {
            ...
            "args0" : [
                    ...
                    },
                    {
                        "type" : "field_dropdown",
                        "name" : "WHERE",
                        "options" : [ [ "%{BKY_TEXT_CHARAT_FROM_START}", "FROM_START" ], [ "%{BKY_TEXT_CHARAT_FROM_END}", "FROM_END" ],
                                [ "%{BKY_TEXT_CHARAT_FIRST}", "FIRST" ], [ "%{BKY_TEXT_CHARAT_LAST}", "LAST" ], [ "%{BKY_TEXT_CHARAT_RANDOM}", "RANDOM" ] ]
                    } ],
            "output" : "String",
            "style" : "text_blocks",
...
Blockly.Blocks['text_count'] = {
    /**
     * Block for counting how many times one string appears within another
     * string.
     * 
     * @this Blockly.Block
     */
...
Blockly.Constants.Text.QUOTE_IMAGE_MIXIN = {
    ...
    QUOTE_IMAGE_LEFT_DATAURI : 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAKCAQAAAAqJXdxAAAA'
            ...
            + 'HNcl9ZQ5oQMM3dgDUqDo1l8DzvwmtZN7mnD+PkmLa+4mhrxVA9fRowBWmVBhFy5gYEjKMf' + 'z9AylsaRRgGzvZAAAAAElFTkSuQmCC',
    /**
    ...
    QUOTE_IMAGE_RIGHT_DATAURI : 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAKCAQAAAAqJXdxAAAA'
            ...
            + 'O3sGPHJDRG6fGVdMSeWDP2q99FQdFrz26Gu5Tq7dFMzUvbXy8KXeAj57cOklgA+u1B5Aos' + 'lLtGIHQMaCVnwDnADZIFIrXsoXrgAAAABJRU5ErkJggg==',
    /**
     ...
     * 
     * @param {string}
     *            fieldName The name of the field to wrap with quotes.
     * @this Blockly.Block
     */
    ...
    /**
     * A helper function that generates a FieldImage of an opening or closing
     * double quote. The selected quote will be adapted for RTL blocks.
     * 
     * @param {boolean}
     *            open If the image should be open quote (“ in LTR). Otherwise,
     *            a closing quote is used (” in LTR).
