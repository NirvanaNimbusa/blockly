...
Blockly.Blocks['procedures_defnoreturn'] = {
    ...
    init : function() {
        ...
        if ((this.workspace.options.comments || (this.workspace.options.parentWorkspace && this.workspace.options.parentWorkspace.options.comments))
    ...
    decompose : function(workspace) {
        /*
         * Creates the following XML: <block type="procedures_mutatorcontainer">
         * <statement name="STACK"> <block type="procedures_mutatorarg"> <field
         * name="NAME">arg1_name</field> <next>etc...</next> </block>
         * </statement> </block>
         */
     ...
     * @param {string}
     *            newId ID of new variable. May be the same as oldId, but with
     *            an updated name. Guaranteed to be the same type as the old
     *            variable.
     * @override
     * @this Blockly.Block
     */
     ...
     * 
     * @param {string}
     *            oldName The old display name of the argument.
     * @param {string}
     *            newName The new display name of the argument.
     * @private
     */
    ...
    customContextMenu : function(options) {
        ...
        if (!this.isCollapsed()) {
            for (var i = 0; i < this.argumentVarModels_.length; i++) {
                ...
                argOption.text = Blockly.Msg['VARIABLES_SET_CREATE_GET'].replace('%1', argVar.name);
...
Blockly.Blocks['procedures_mutatorcontainer'] = {
     ...
     * that when a new block is dragged out it will have a unique parameter
     * name.
     * 
...
Blockly.Blocks['procedures_mutatorarg'] = {
     ...
     * necessary. Merge runs of whitespace. Strip leading and trailing
     * whitespace. Beyond this, all names are legal.
     * 
     * @param {string}
     *            varName User-supplied name.
    ...
    /**
     * Called when focusing away from the text field. Deletes all variables that
     * were created as the user typed their intended variable name.
     * 
     * @param {string}
     *            newText The new variable name.
     * @private
     * @this Blockly.FieldTextInput
     */
    ...
    onchange : function(event) {
        ...
        if (event.type == Blockly.Events.BLOCK_CREATE && event.ids.indexOf(this.id) != -1) {
            ...
            if (!def) {
                ...
                /**
                 * Create matching definition block. <xml
                 * xmlns="https://developers.google.com/blockly/xml"> <block
                 * type="procedures_defreturn" x="10" y="20"> <mutation
                 * name="test"> <arg name="x"></arg> </mutation> <field
                 * name="NAME">test</field> </block> </xml>
                 */
